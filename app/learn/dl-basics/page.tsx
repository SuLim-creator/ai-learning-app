...
export default function DlBasicsPage() {
  const lessons = getLessons("dl-basics");

  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      <div className="mx-auto max-w-2xl px-4 py-10">
        <div className="mb-8">
          <p className="mb-1 text-sm text-indigo-400">3단계</p>
          <h1 className="mb-2 text-2xl font-bold text-white">딥러닝 입문</h1>
          <p className="text-sm text-gray-400">
            신경망의 작동 원리를 직관적으로 학습합니다.
          </p>
